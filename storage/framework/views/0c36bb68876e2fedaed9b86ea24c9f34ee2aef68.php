...
<div class="container marketing">
    ...
    <div class="row featurette">
        ...
        <div class="col-md-5 col-md-pull-7">
            <img src="<?php echo e(asset('img/about/make.jpg')); ?>" class="featurette-image img-responsive center-block"
    ...
    <div class="row featurette">
        ...
        <div class="col-md-5  col-md-pull-7">
            <img src="<?php echo e(asset('img/about/product.jpg')); ?>" class="featurette-image img-responsive center-block"
    ...
    <div class="row featurette">
        ...
        <div class="col-md-5  col-md-pull-7">
            <img src="<?php echo e(asset('img/about/galeri.jpg')); ?>" class="featurette-image img-responsive center-block"
...
<?php echo $__env->make('layouts.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OJT\resources\views/balipasadena/contact.blade.php ENDPATH**/ ?>